...
So if we resample our data many times, the CI constructed will contain the true value of the parameter 75% of the times.
...
This is what some people usually confuse with the frequentist confidence interval.
