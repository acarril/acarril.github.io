...
In this post I explain the basics of running batch jobs with Stata. I also wrote a [second part](posts/batch-processes) which deals with running multiple processes in parallel.
