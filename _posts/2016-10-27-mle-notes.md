...
[Maximum likelihood estimators](https://en.wikipedia.org/wiki/Maximum_likelihood_estimation) (MLE) are widely in econometric analysis. Although their mathematical derivation is found in many textbooks, I've always wanted to explore the process from a data-driven perspective. In this post I'll go over the intuition of what MLE do, using R (and a bit of math) to better understand the underpinnings of this method.
