...
Just head to [sublimetext.com](https://www.sublimetext.com) and download Sublime Text 3 (ST3) for your operating system.

Once you've installed it, you'll definitely want to add Package Control, which lets you easily add and remove additional plugins. Just follow [these instructions](https://packagecontrol.io/installation) to install it.

We'll use Package Control to add several plugins that will let us use ST3 to edit and compile the following programs:
