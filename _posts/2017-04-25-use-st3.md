...
Switching to Sublime has been the single biggest productivity booster in years. First, take a look at how gorgeous it is:
...
Head to [sublimetext.com](https://www.sublimetext.com) and download Sublime Text 3 (ST3) for your operating system. Once you've installed it, you'll want to add **Package Control**, which lets you easily add and remove additional plugins. Just follow [these instructions](https://packagecontrol.io/installation) to install it.

Using package control we can add several plugins that will let us use ST3 to edit and compile the following programs:
