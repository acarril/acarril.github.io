...
Whether to use Python 2 or 3 is still a hotly debated topic, as [a Google search will reveal](https://www.google.com/?gfe_rd=cr&gws_rd=cr#safe=off&q=python+2+vs+3). My recommendation is to take it easy, because (a) their syntax is fairly similar, (b) you can later switch and (c) the "typical" data science packages work for both versions.
